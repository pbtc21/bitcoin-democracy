...
(define-public (pay-for-access)
  (let
    ...
    (unwrap! (contract-call? .mock-sbtc transfer price payer (var-get treasury) none) ERR-TRANSFER-FAILED)
...
(define-public (pay-bulk (count uint))
  (let
    ...
    ;; Transfer sBTC
    (unwrap! (contract-call? .mock-sbtc transfer bulk-price payer (var-get treasury) none) ERR-TRANSFER-FAILED)
